                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        function renderstatus(data, cell, row) {
                            if (data == 'Paid')
                                return '<div class="badge bg-success p-2 px-3 payroll-status"><a href="#" class="text-white">' +
                                    data + '</a></div>';
                            else
                                return '<div class="badge bg-danger p-2 px-3 payroll-status"><a href="#" class="text-white">' +
                                    data + '</a></div>';
                        }
                        ...
                        if (data.length > 0) {
                            $.each(data, function(indexInArray, valueOfElement) {
                                var status =
                                    '<div class="badge bg-danger p-2 px-3 payroll-status"><a href="#" class="text-white">' +
                                    valueOfElement[6] + '</a></div>';
                                if (valueOfElement[6] == 'Paid' || valueOfElement[6] ==
                                    'paid') {
                                    var status =
                                        '<div class="badge bg-success p-2 px-3 payroll-status"><a href="#" class="text-white">' +
                                        valueOfElement[6] + '</a></div>';
                                }
